          ...
          <CardContent>
            {generatedContent ? (
              <div className="flex flex-col gap-4">
                <div className="whitespace-pre-wrap text-slate-200 font-mono text-xs">{generatedContent}</div>
                <Button onClick={copyToClipboard} variant="secondary" size="sm">Copiar Texto</Button>
              </div>
            ) : (
              <div className="h-40 flex items-center justify-center opacity-50"><p>O resultado aparecerá aqui...</p></div>
            )}
          </CardContent>
        </Card>
      </div>
